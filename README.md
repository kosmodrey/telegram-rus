...
Перевод исправляет правописание слов, с наименьшем использованием ино-странных слов. За основу был взят уже существующий перевод, поэтому слова нуждаются в активных проверках и исправлениях.
